...
function NameForm(props) {
  // input 태그에 사용할 변수 선언, useState를 사용하여 state로 상태 관리, 초기값 ''(빈 문자열)
  ...
  return (
    <form onSubmit={handleSubmit}>
      <div className={'my-3'}>
        ...
        {/* input 태그의 value 속성은 기본값은 '', value에 값을 입력 시 기본값으로 화면에 출력 */}
        {/* 리액트에서는 state로 관리하고 있는 변수를 value 속성의 값으로 사용 */}
