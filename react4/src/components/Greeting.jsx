...
// 자바스크립트에서 조건식으로 데이터를 구분할 경우 true 및 false 2가지 경우로 구분할 수 있는데, 여기서 데이터에 따라 Truthy로 구분하거나 Falsy로 구분할 수 있음
// 간단하게 데이터가 있으면 Truthy이고, 데이터가 없으면 Falsy라고 할 수 있음
// truthy : true(Boolean 값 true), {}(빈 object타입), [](빈 배열), 100, -200(0이 아닌 숫자), "0", "false"(빈 문자열이 아닌 문자열)
