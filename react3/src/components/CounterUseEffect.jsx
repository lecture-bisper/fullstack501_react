...
function CounterUseEffect(props) {
  ...
  // effect콜백함수 : useEffect 사용 시 동작할 소스코드
  // 의존성 배열 : 의존성 배열로 지정한 배열의 내용이 변경 시 useEffect 가 동작
  ...
  // useEffect 사용 시 effect콜백 함수에 retrun 부분에 콜백함수를 입력하면 콜백함수를 컴포넌트가 삭제될 때 useEffect 가 동작함
  useEffect(() => {
    return () => {
