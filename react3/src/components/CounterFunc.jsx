...
function CounterFunc(props) {
  // 리액트는 UI 화면을 Virtual DOM 이라는 것을 사용하여 먼저 UI 화면을 만들고, 실제 사용자가 보고 있는 DOM 화면과 교체함
  ...
  // useMemo : 기존에 수행한 결과값을 저장해두고 동일한 입력이 들어왔을 경우 해당 데이터를 재활용하여 로딩 속도를 높임
  // useCallback : useMemo와 동일한 기능이지만 useMemo는 결과값을 재활용하지만 useCallback은 함수를 재활용함
