...
import './index.css';
// 디폴트 export로 지정된 요소를 App.js에서 가져옴
import App from './App';
...
// 2라인 이상 나올 경우는 반드시 () 가 있어야 함
// return 되는 내용의 부모가 되는 태그는 반드시 1개이어야 함
function TestPage() {
